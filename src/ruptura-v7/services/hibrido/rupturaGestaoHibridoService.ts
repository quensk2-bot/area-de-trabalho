...
function mapProduto(p: HibridoProdutoGestao, ctx: RupturaFiltrosProdutos): RupturaProdutoLoja {
  return {
    ...
    cross_docking: p.crossDocking === 1,
    soma_estoque_cd: p.somaEstoqueCd,
    pendencia_cpa_cd: p.pendenciaCpaCd,
    dias_pedido: p.diasPedido,
    dias_ruptura: p.diasRuptura,
    embalagem_compra: p.embalagemCompra,
    acao_curto_prazo: p.acaoCurtoPrazo,
    acao_medio_prazo: p.acaoMedioPrazo ?? null,
    ...
    status_solicitacao_ativacao_cd: p.statusSolicitacaoAtivacaoCd ?? null,
    quantidade_cds: null,
    qualidade_dados: p.qualidadeDados,
    status_operacional: null,
    curto_prazo_rebto_proximo: p.curtoPrazoRebtoProximo ?? null,
    curto_prazo_nao_rebto_proximo: p.curtoPrazoNaoRebtoProximo ?? null,
    est_selec_inv_cd1: p.estSelecInvCd1 ?? null,
    est_selec_inv_cd2: p.estSelecInvCd2 ?? null,
    est_selec_inv_cd3: p.estSelecInvCd3 ?? null,

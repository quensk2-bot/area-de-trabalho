...
import type { MotorCentralizacaoEntrada, MotorMenorRecebimentoResultado, PosicaoLogicaCd } from "./centralizacaoTypes.ts";
import {
...
export function calcularMenorRecebimento(entrada: MotorCentralizacaoEntrada): MotorMenorRecebimentoResultado {
  ...
  const posicoesComMenorValor: PosicaoLogicaCd[] = [];
